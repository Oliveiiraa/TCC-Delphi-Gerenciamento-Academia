...
begin
  if edt_nmusu.Text = EmptyStr then
  begin
    MessageDlg('Entre com o nome de usúario!',mtError,[mbOK],0);
    edt_nmusu.SetFocus;
    Exit;
  end
  else if edt_login.Text = EmptyStr then
  begin
...
begin
  ...
  else if ComboBoxTipoUsu.ItemIndex = -1 then
  begin
    MessageDlg('Escolha o tipo de usuário!',mtError,[mbOK],0);
    ComboBoxTipoUsu.SetFocus;
    Exit;
  end;
