...
begin
 ...
 /// if datap > datav  then
  ...
  ///end;
    ...
    //Arquivo.SaveToFile ('C:\Sistema Bio Ritmo\RECIBO DE PAGAMENTO.dotx'); //salva o arquivo em outro lugar, como o mesmo nome, mas não necessária precisar ser com o mesmo nome.
