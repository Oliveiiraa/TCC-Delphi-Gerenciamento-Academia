...
begin
  ...
  begin
    MessageDlg('Informe a medida do bíceps!',mtError,[mbOK],0);
    edt_biceps.SetFocus;
    Exit;
  end
  ...
  begin
    MessageDlg('Informe a medida do tríceps!',mtError,[mbOK],0);
  ...
  begin
    MessageDlg('Informe a data da avaliação!',mtError,[mbOK],0);
