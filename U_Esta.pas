...
procedure Tfrm_esta.Button1Click(Sender: TObject);
begin
{   try
  begin
    ADOStoredProc1.Parameters[1].Value := Edit_alunosativos.Text;
    ADOStoredProc1.Parameters[2].Value := Edit_alunosinativos.Text;
    ///MaskEdit1.EditMask := '!999.999.999-99;1;_';  /////
    ADOStoredProc1.Parameters[3].Value := Edit_ganho.Text;
    ADOStoredProc1.Parameters[4].Value := Edit_lucro.Text;
    ADOStoredProc1.Parameters[5].Value := Edit_totalalunos.Text;
    ADOStoredProc1.Parameters[6].Value := Edit_despesas.Text;

    ADOStoredProc1.ExecProc;

    ShowMessage('cadastro feito!!!!!');
  end;
   finally
...
procedure Tfrm_esta.Image9Click(Sender: TObject);
begin
 close;
end;
