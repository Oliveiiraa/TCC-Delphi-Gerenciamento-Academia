...
begin
  ...
  begin
    MessageDlg('Informe a medida do bíceps!',mtInformation,[mbOK],0);
    edt_biceps.SetFocus;
    Exit;
  end
  ...
  begin
    MessageDlg('Informe a medida do tríceps!',mtInformation,[mbOK],0);
  ...
  begin
    MessageDlg('Informe a data da avaliação!',mtInformation,[mbOK],0);
